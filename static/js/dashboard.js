...
(function() {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // ✅ Handler de resize (referência nomeada para poder remover depois)
        let resizeTimeout;
        ...
        // ✅ Adicionar listener de resize com função nomeada (para poder remover depois)
        ...
        // ================== CLEANUP NO UNLOAD (CORRIGIDO) ==================
        // ✅ ✅ ✅ CORREÇÃO CRÍTICA: Sem arguments.callee (proibido em strict mode) ✅ ✅ ✅
        function cleanup() {
            ...
            // ✅ REMOVIDO: window.removeEventListener('resize', arguments.callee);
            // ✅ CORREÇÃO: Usar a função nomeada handleResize que foi definida no início
